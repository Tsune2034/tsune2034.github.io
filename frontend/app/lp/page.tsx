...
const copy: Record<Locale, {
  ...
  en: {
    ...
    kairos_body: "In ancient Greek, Kairos means the perfect moment — the right timing.\nKAIROX = Kairos (perfect timing) + X (express).\n\nDon't waste the best moments of your trip carrying heavy bags.\nYour luggage arrives at the hotel before you're back.\nUse that half-day for one more extraordinary experience.",
    ...
    cta2: "You worked hard for this.\nDon't spend it carrying bags.",
  ...
  zh: {
    ...
    kairos_body: "古希臘語「Kairos」代表最佳時機、重要的瞬間。\nKAIROX = Kairos（好機）+ X（急行）。\n\n不讓行李的重量浪費旅途中最珍貴的瞬間。\n回到飯店時，行李已經送達。\n用那半天，去體驗另一個非日常的世界。",
  ...
  ko: {
    ...
    kairos_body: "그리스어 'Kairos'는 절호의 기회, 중요한 타이밍을 의미합니다.\nKAIROX = Kairos(절호의 기회) + X(특급).\n\n여행의 가장 소중한 순간을 짐 때문에 낭비하지 마세요.\n호텔에 돌아올 때쯤, 짐은 이미 도착해 있습니다.\n그 반나절로, 또 하나의 비일상적인 세계로.",
