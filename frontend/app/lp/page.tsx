...
const copy: Record<Locale, {
  ...
  en: {
    ...
    area_body: "New Chitose Airport / Chitose / Sapporo / Otaru / Furano & Biei / Narita Airport / Tokyo",
  ...
  zh: {
    ...
    area_title: "服務範圍",
    area_body: "新千歲機場 / 千歲・苫小牧 / 札幌 / 小樽 / 富良野・美瑛 / 成田機場 / 東京",
    cta2: "輕裝上陣，盡情享受日本。",
    cta2_sub: "30 秒即可預訂。",
    footer_company: "One Hour Value Inc.",
  ...
  ko: {
    ...
    area_title: "서비스 지역",
    area_body: "신치토세공항 / 치토세・도마코마이 / 삿포로 / 오타루 / 후라노・비에이 / 나리타공항 / 도쿄",
...
const SIMULATOR = {
  narita: {
    destinations: [
      { label: "東京都心（新宿・渋谷・銀座）", base: 3500 },
      { label: "浅草・上野・秋葉原",           base: 3500 },
      { label: "横浜",                         base: 4500 },
      { label: "千葉市内",                     base: 2800 },
      { label: "鎌倉",                         base: 5500 },
    ],
  },
  chitose: {
