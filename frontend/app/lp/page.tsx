...
const copy: Record<Locale, {
  ...
  ja: {
    ...
    area_title: "対応エリア",
    area_body: "新千歳空港 / 千歳・苫小牧 / 札幌 / 小樽 / 函館 / 知床・網走 / 成田空港 / 東京都心　｜　ニセコ・富良野 展開予定",
  ...
  en: {
    ...
    area_body: "New Chitose Airport / Chitose / Sapporo / Otaru / Hakodate / Shiretoko & Abashiri / Narita Airport / Tokyo  |  Niseko & Furano: coming soon",
  ...
  zh: {
    ...
    area_title: "服務範圍",
    area_body: "新千歲機場 / 千歲・苫小牧 / 札幌 / 小樽 / 函館 / 知床・網走 / 成田機場 / 東京　｜　ニセコ・富良野 即將開通",
    cta2: "輕裝上陣，盡情享受日本。",
    cta2_sub: "30 秒即可預訂。",
    footer_company: "One Hour Value Inc.",
  ...
  ko: {
    ...
    area_title: "서비스 지역",
    area_body: "신치토세공항 / 치토세・도마코마이 / 삿포로 / 오타루 / 하코다테 / 시레토코・아바시리 / 나리타공항 / 도쿄　｜　니세코・후라노 서비스 예정",
